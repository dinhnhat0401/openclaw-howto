...
For integration health monitoring routines, see **[OPERATIONS.md](../OPERATIONS.md)**. For production integration patterns, see **[POWER_USER_PLAYBOOK.md](../POWER_USER_PLAYBOOK.md)**. For a quick command cheat sheet, see **[QUICK_REFERENCE.md](../QUICK_REFERENCE.md)**. For the full command reference, see **[CATALOG.md](../CATALOG.md)**. For a guided path through all modules, see **[LEARNING-ROADMAP.md](../LEARNING-ROADMAP.md)**.
